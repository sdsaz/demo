...
@Injectable()
export class CommunicationService extends HttpHelperService {

  private apiGatewayUrl = environment.apiGatewayUrl + "communicationservice/"; //api gateway + service name
